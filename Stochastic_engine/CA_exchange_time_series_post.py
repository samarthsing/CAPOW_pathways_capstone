...
for year in range(100):    
    ...
    dhydro.to_csv('Hydro_setup/Hydro_for_stackplot/CA{}_dispatchable_hydro.csv'.format(str(year)))
    ...
    H = pd.DataFrame(hourly)
    H.columns = zones
    H.to_csv('Hydro_setup/Hydro_for_stackplot/CA{}_hydro_mins.csv'.format(str(year)))

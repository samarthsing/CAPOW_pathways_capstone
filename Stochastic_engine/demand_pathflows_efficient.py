...
def demand(job_id):
    ...
    sim_BPA_hydro = pd.read_csv('PNW_hydro/FCRPS/Path_dams_{}.csv'.format(job_id),header=None)
    sim_BPA_hydro=sim_BPA_hydro.values
    sim_BPA_hydro=np.sum(sim_BPA_hydro,axis=1)/24
    sim_wind_power=pd.read_csv('Synthetic_wind_power/wind_power_sim_{}.csv'.format(job_id),header=0)
    sim_Hoover = pd.read_csv('Synthetic_streamflows/synthetic_discharge_Hoover_{}.csv'.format(job_id),header=None)
    ...
    sim_weather=pd.read_csv('Synthetic_weather/synthetic_weather_data_{}.csv'.format(job_id),header=0,index_col=0)
    ...
    if len(y70p) > 0:
        regBPA70p.fit(X70p,y70p)
    if len(y65_70) > 0:
        regBPA65_70.fit(X65_70,y65_70)
    if len(y60_65) > 0:
        regBPA60_65.fit(X60_65,y60_65)
    if len(y55_60) > 0:
        regBPA55_60.fit(X55_60,y55_60)
    if len(y50_55) > 0:
        regBPA50_55.fit(X50_55,y50_55)
    if len(y40_50) > 0:
        regBPA40_50.fit(X40_50,y40_50)
    if len(y30_40) > 0:
        regBPA30_40.fit(X30_40,y30_40)
    if len(y25_30) > 0:
        regBPA25_30.fit(X25_30,y25_30)
    if len(y25m) > 0:
        regBPA25m.fit(X25m,y25m)
    ...
    for i in range(0,num_days):
        ...
        s = s.reshape((1,len(s)))
        if M[i,0]>=70:      
            y_hat = regBPA70p.predict(s)
        elif M[i,0] >= 65 and M[i,0] < 70:
            y_hat = regBPA65_70.predict(s)
        elif M[i,0] >= 60 and M[i,0] < 65:
            y_hat = regBPA60_65.predict(s)        
        elif M[i,0] >= 55 and M[i,0] < 60:
            y_hat = regBPA55_60.predict(s)
        elif M[i,0] >= 50 and M[i,0] < 55:
            y_hat = regBPA50_55.predict(s)          
        elif M[i,0] >= 40 and M[i,0] < 50:
            y_hat = regBPA40_50.predict(s)
        elif M[i,0] >= 30 and M[i,0] < 40:
            y_hat = regBPA30_40.predict(s)
        elif M[i,0] >= 25 and M[i,0] < 30:
            y_hat = regBPA25_30.predict(s)
        elif M[i,0] < 25:
            y_hat = regBPA25m.predict(s)
    ...
    ## Train the model using the training sets
    if len(y80p) > 0:
        regSDGE80p.fit(X80p,y80p)   
    if len(y75_80) > 0:
        regSDGE75_80.fit(X75_80,y75_80)
    if len(y70_75) > 0:
        regSDGE70_75.fit(X70_75,y70_75)      
    if len(y65_70) > 0:
        regSDGE65_70.fit(X65_70,y65_70)
    if len(y60_65) > 0:
        regSDGE60_65.fit(X60_65,y60_65)
    if len(y55_60) > 0:
        regSDGE55_60.fit(X55_60,y55_60)
    if len(y50_55) > 0:
        regSDGE50_55.fit(X50_55,y50_55)
    if len(y50) > 0:
        regSDGE50m.fit(X50,y50)
    ...
    for i in range(0,num_days):
        ...
        s = s.reshape((1,len(s)))
        if M[i,0]>=80:      
            y_hat = regSDGE80p.predict(s)
        elif M[i,0] >= 75 and M[i,0] < 80:
            y_hat = regSDGE75_80.predict(s)
        elif M[i,0] >= 70 and M[i,0] < 75:
            y_hat = regSDGE70_75.predict(s)           
        elif M[i,0] >= 65 and M[i,0] < 70:
            y_hat = regSDGE65_70.predict(s)
        elif M[i,0] >= 60 and M[i,0] < 65:
            y_hat = regSDGE60_65.predict(s)        
        elif M[i,0] >= 55 and M[i,0] < 60:
            y_hat = regSDGE55_60.predict(s)
        elif M[i,0] >= 50 and M[i,0] < 55:
            y_hat = regSDGE50_55.predict(s)    
        elif M[i,0] < 50:
            y_hat = regSDGE50m.predict(s)
    ...
    ## Train the model using the training sets
    if len(y80p) > 0:
        regSCE80p.fit(X80p,y80p)
    if len(y75_80) > 0:
        regSCE75_80.fit(X75_80,y75_80)
    if len(y70_75) > 0:
        regSCE70_75.fit(X70_75,y70_75)      
    if len(y65_70) > 0:
        regSCE65_70.fit(X65_70,y65_70)
    if len(y60_65) > 0:
        regSCE60_65.fit(X60_65,y60_65)
    if len(y55_60) > 0:
        regSCE55_60.fit(X55_60,y55_60)
    if len(y50_55) > 0:
        regSCE50_55.fit(X50_55,y50_55)
    if len(y50) > 0:
        regSCE50m.fit(X50,y50)
    ...
    for i in range(0,num_days):
        ...
        s = s.reshape((1,len(s)))
        if M[i,0]>=80:      
            y_hat = regSCE80p.predict(s)
        elif M[i,0] >= 75 and M[i,0] < 80:
            y_hat = regSCE75_80.predict(s)
        elif M[i,0] >= 70 and M[i,0] < 75:
            y_hat = regSCE70_75.predict(s)           
        elif M[i,0] >= 65 and M[i,0] < 70:
            y_hat = regSCE65_70.predict(s)
        elif M[i,0] >= 60 and M[i,0] < 65:
            y_hat = regSCE60_65.predict(s)        
        elif M[i,0] >= 55 and M[i,0] < 60:
            y_hat = regSCE55_60.predict(s)
        elif M[i,0] >= 50 and M[i,0] < 55:
            y_hat = regSCE50_55.predict(s)    
        elif M[i,0] < 50:
            y_hat = regSCE50m.predict(s)
    ...
    ## Train the model using the training sets
    if len(y80p) > 0:
        regPGEV80p.fit(X80p,y80p)
    if len(y75_80) > 0:
        regPGEV75_80.fit(X75_80,y75_80)
    if len(y70_75) > 0:
        regPGEV70_75.fit(X70_75,y70_75)      
    if len(y65_70) > 0:
        regPGEV65_70.fit(X65_70,y65_70)
    if len(y60_65) > 0:
        regPGEV60_65.fit(X60_65,y60_65)
    if len(y55_60) > 0:
        regPGEV55_60.fit(X55_60,y55_60)
    if len(y50_55) > 0:
        regPGEV50_55.fit(X50_55,y50_55)
    if len(y50) > 0:
        regPGEV50m.fit(X50,y50)
    ...
    for i in range(0,num_days):
        ...
        s = s.reshape((1,len(s)))
        if M[i,0]>=80:      
            y_hat = regPGEV80p.predict(s)
        elif M[i,0] >= 75 and M[i,0] < 80:
            y_hat = regPGEV75_80.predict(s)
        elif M[i,0] >= 70 and M[i,0] < 75:
            y_hat = regPGEV70_75.predict(s)           
        elif M[i,0] >= 65 and M[i,0] < 70:
            y_hat = regPGEV65_70.predict(s)
        elif M[i,0] >= 60 and M[i,0] < 65:
            y_hat = regPGEV60_65.predict(s)        
        elif M[i,0] >= 55 and M[i,0] < 60:
            y_hat = regPGEV55_60.predict(s)
        elif M[i,0] >= 50 and M[i,0] < 55:
            y_hat = regPGEV50_55.predict(s)    
        elif M[i,0] < 50:
            y_hat = regPGEV50m.predict(s)
    ...
    ## Train the model using the training sets
    if len(y80p) > 0:
        regPGEB80p.fit(X80p,y80p)   
    if len(y75_80) > 0:
        regPGEB75_80.fit(X75_80,y75_80)
    if len(y70_75) > 0:
        regPGEB70_75.fit(X70_75,y70_75)      
    if len(y65_70) > 0:
        regPGEB65_70.fit(X65_70,y65_70)
    if len(y60_65) > 0:
        regPGEB60_65.fit(X60_65,y60_65)
    if len(y55_60) > 0:
        regPGEB55_60.fit(X55_60,y55_60)
    if len(y50_55) > 0:
        regPGEB50_55.fit(X50_55,y50_55)
    if len(y50) > 0:
        regPGEB50m.fit(X50,y50)
    ...
    for i in range(0,num_days):
        ...
        s = s.reshape((1,len(s)))
        if M[i,0]>=80:      
            y_hat = regPGEB80p.predict(s)
        elif M[i,0] >= 75 and M[i,0] < 80:
            y_hat = regPGEB75_80.predict(s)
        elif M[i,0] >= 70 and M[i,0] < 75:
            y_hat = regPGEB70_75.predict(s)           
        elif M[i,0] >= 65 and M[i,0] < 70:
            y_hat = regPGEB65_70.predict(s)
        elif M[i,0] >= 60 and M[i,0] < 65:
            y_hat = regPGEB60_65.predict(s)        
        elif M[i,0] >= 55 and M[i,0] < 60:
            y_hat = regPGEB55_60.predict(s)
        elif M[i,0] >= 50 and M[i,0] < 55:
            y_hat = regPGEB50_55.predict(s)    
        elif M[i,0] < 50:
            y_hat = regPGEB50m.predict(s)
    ...
    for line in lines:
        ...
        globals()[name] = linear_model.LinearRegression()
        ...
        name='jan_reg_NW' + str(line)
        globals()[name].fit(jan.loc[:,'BPA_wind':],jan.loc[:,line]) 
        
        name='feb_reg_NW' + str(line)
        globals()[name].fit(feb.loc[:,'BPA_wind':],feb.loc[:,line])
        
        name='mar_reg_NW' + str(line)
        globals()[name].fit(mar.loc[:,'BPA_wind':],mar.loc[:,line])
        
        name='apr_reg_NW' + str(line)
        globals()[name].fit(apr.loc[:,'BPA_wind':],apr.loc[:,line])
        
        name='may_reg_NW' + str(line)
        globals()[name].fit(may.loc[:,'BPA_wind':],may.loc[:,line])

        name='jun_reg_NW' + str(line)
        globals()[name].fit(jun.loc[:,'BPA_wind':],jun.loc[:,line])
        
        name='jul_reg_NW' + str(line)
        globals()[name].fit(jul.loc[:,'BPA_wind':],jul.loc[:,line])
        
        name='aug_reg_NW' + str(line)
        globals()[name].fit(aug.loc[:,'BPA_wind':],aug.loc[:,line])
        
        name='sep_reg_NW' + str(line)
        globals()[name].fit(sep.loc[:,'BPA_wind':],sep.loc[:,line])
        
        name='oct_reg_NW' + str(line)
        globals()[name].fit(oct.loc[:,'BPA_wind':],oct.loc[:,line])
        
        name='nov_reg_NW' + str(line)
        globals()[name].fit(nov.loc[:,'BPA_wind':],nov.loc[:,line])
        
        name='dec_reg_NW' + str(line)
        globals()[name].fit(dec.loc[:,'BPA_wind':],dec.loc[:,line])    
    ...
    for line in lines:
        ...
        globals()[name_1] = linear_model.LinearRegression()
        globals()[name_2] = linear_model.LinearRegression()
        globals()[name_3] = linear_model.LinearRegression()
        globals()[name_4] = linear_model.LinearRegression()
        globals()[name_5] = linear_model.LinearRegression()
        globals()[name_6] = linear_model.LinearRegression()
        globals()[name_7] = linear_model.LinearRegression()
        globals()[name_8] = linear_model.LinearRegression()
        globals()[name_9] = linear_model.LinearRegression()
        globals()[name_10] = linear_model.LinearRegression()
        globals()[name_11] = linear_model.LinearRegression()
        globals()[name_12] = linear_model.LinearRegression()


        
        # Train the model using the training sets
        globals()[name_1].fit(jan.loc[:,'BPA_wind':],jan.loc[:,line])
        globals()[name_2].fit(feb.loc[:,'BPA_wind':],feb.loc[:,line])
        globals()[name_3].fit(mar.loc[:,'BPA_wind':],mar.loc[:,line])
        globals()[name_4].fit(apr.loc[:,'BPA_wind':],apr.loc[:,line])
        globals()[name_5].fit(may.loc[:,'BPA_wind':],may.loc[:,line])
        globals()[name_6].fit(jun.loc[:,'BPA_wind':],jun.loc[:,line])
        globals()[name_7].fit(jul.loc[:,'BPA_wind':],jul.loc[:,line])
        globals()[name_8].fit(aug.loc[:,'BPA_wind':],aug.loc[:,line])
        globals()[name_9].fit(sep.loc[:,'BPA_wind':],sep.loc[:,line])
        globals()[name_10].fit(oct.loc[:,'BPA_wind':],oct.loc[:,line])
        globals()[name_11].fit(nov.loc[:,'BPA_wind':],nov.loc[:,line])
        globals()[name_12].fit(dec.loc[:,'BPA_wind':],dec.loc[:,line])
        ...
        for i in range(0,len(y)):
            ...
            if m==1:
                s = jan.loc[i,'BPA_wind':]
                s = np.reshape(s[:,None],(1,n))
                p = globals()[name_1].predict(s)
                predicted = np.append(predicted,p)
            elif m==2:
                s = feb.loc[i,'BPA_wind':]
                s = np.reshape(s[:,None],(1,n))
                p = globals()[name_2].predict(s)
                predicted = np.append(predicted,p)
            elif m==3:
                s = mar.loc[i,'BPA_wind':]
                s = np.reshape(s[:,None],(1,n))
                p = globals()[name_3].predict(s)
                predicted = np.append(predicted,p)
            elif m==4:
                s = apr.loc[i,'BPA_wind':]
                s = np.reshape(s[:,None],(1,n))
                p = globals()[name_4].predict(s)
                predicted = np.append(predicted,p)
            elif m==5:
                s = may.loc[i,'BPA_wind':]
                s = np.reshape(s[:,None],(1,n))
                p = globals()[name_5].predict(s)
                predicted = np.append(predicted,p)
            elif m==6:
                s = jun.loc[i,'BPA_wind':]
                s = np.reshape(s[:,None],(1,n))
                p = globals()[name_6].predict(s)
                predicted = np.append(predicted,p)
            elif m==7:
                s = jul.loc[i,'BPA_wind':]
                s = np.reshape(s[:,None],(1,n))
                p = globals()[name_7].predict(s)
                predicted = np.append(predicted,p)
            elif m==8:
                s = aug.loc[i,'BPA_wind':]
                s = np.reshape(s[:,None],(1,n))
                p = globals()[name_8].predict(s)
                predicted = np.append(predicted,p)
            elif m==9:
                s = sep.loc[i,'BPA_wind':]
                s = np.reshape(s[:,None],(1,n))
                p = globals()[name_9].predict(s)
                predicted = np.append(predicted,p)
            elif m==10:
                s = oct.loc[i,'BPA_wind':]
                s = np.reshape(s[:,None],(1,n))
                p = globals()[name_10].predict(s)
                predicted = np.append(predicted,p)
            elif m==11:
                s = nov.loc[i,'BPA_wind':]
                s = np.reshape(s[:,None],(1,n))
                p = globals()[name_11].predict(s)
                predicted = np.append(predicted,p)
            else:
                s = dec.loc[i,'BPA_wind':]
                s = np.reshape(s[:,None],(1,n))
                p = globals()[name_12].predict(s)
                predicted = np.append(predicted,p)
    ...
    for line in lines:
        ...
        # Train the model using the training sets
        globals()[name_1].fit(jan.loc[:,'Wind':],jan.loc[:,line])
        globals()[name_2].fit(feb.loc[:,'Wind':],feb.loc[:,line])
        globals()[name_3].fit(mar.loc[:,'Wind':],mar.loc[:,line])
        globals()[name_4].fit(apr.loc[:,'Wind':],apr.loc[:,line])
        globals()[name_5].fit(may.loc[:,'Wind':],may.loc[:,line])
        globals()[name_6].fit(jun.loc[:,'Wind':],jun.loc[:,line])
        globals()[name_7].fit(jul.loc[:,'Wind':],jul.loc[:,line])
        globals()[name_8].fit(aug.loc[:,'Wind':],aug.loc[:,line])
        globals()[name_9].fit(sep.loc[:,'Wind':],sep.loc[:,line])
        globals()[name_10].fit(oct.loc[:,'Wind':],oct.loc[:,line])
        globals()[name_11].fit(nov.loc[:,'Wind':],nov.loc[:,line])
        globals()[name_12].fit(dec.loc[:,'Wind':],dec.loc[:,line])
    ...
    for pathway in pathways:
        ...
        for j in yrs:
            ...
            EV_load_BPA = df_EV[column].values
            EV_load_CAISO = df_EV[column2].values
            sim_BPA_wind_power= sim_wind_power.loc[:,column]/24
    ...
    #        Demand_Path['PGEB_Load_sim']=syn_PGEB.tolist()
            ...
            Demand_Path.to_csv(filename.format(job_id))
            ...
            df_C.to_csv(filename.format(job_id))

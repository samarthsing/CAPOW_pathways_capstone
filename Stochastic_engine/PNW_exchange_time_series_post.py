...
for year in range(100):    
    ...
    dispatchable_hydro.to_csv('Hydro_setup/Hydro_for_stackplot/PNW{}_dispatchable_hydro.csv'.format(str(year)))
    ...
    H = pd.DataFrame(hourly)
    H.columns = ['PNW']
    H.to_csv('Hydro_setup/Hydro_for_stackplot/PNW{}_hydro_mins.csv'.format(str(year)))
